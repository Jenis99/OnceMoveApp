    ...
    return Obx(
      () => Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          elevation: 10.0,
          items: const [
            BottomNavigationBarItem(icon: ImageIcon(AssetImage(IconRes.homeIcon)), label: "Home"),
            BottomNavigationBarItem(icon: ImageIcon(AssetImage(IconRes.secondIcon)), label: "Second"),
            BottomNavigationBarItem(icon: ImageIcon(AssetImage(IconRes.chatIcon)), label: "Chat"),
            BottomNavigationBarItem(icon: ImageIcon(AssetImage(IconRes.profileIcon)), label: "Profile"),
          ],
        ),
        body: Obx(() => IndexedStack(
              index: bottomNavController.tabIndex.value,
              children: [HomeScreen(), MyOrderScreen(), ChatScreen(), ProfileScreen()],
            )),
      ),
    );
  }
