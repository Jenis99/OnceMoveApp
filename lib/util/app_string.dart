class AppString{
  ...
  static String forgetEmailDocId="forgotDocId";
  static String validOTP="Please enter valid OTP";
  static String passUpdated="Your password is successfully updated";
  static String plsSelectImg="Please Select Image";
